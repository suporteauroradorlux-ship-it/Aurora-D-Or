...
<body>
  ...
  <main class="container" id="home">
    ...
    <section id="sobre" style="margin-top:40px">
      <h2 style="color:var(--white); font-size:32px; margin-bottom: 20px;">A Lenda de Aurora D'Or</h2>
      
      <div style="display:grid; grid-template-columns: 1fr; gap: 20px;">
        <div>
          <p class="muted" style="font-size: 1.1rem; line-height: 1.6; margin-bottom: 20px; color: #e0e0e0;">
          ...
          <p class="muted" style="font-size: 1.1rem; line-height: 1.6; color: #bfb7a1;">
          ...
          <div style="margin-top:24px; font-family:'Playfair Display', serif; font-style: italic; color:var(--gold); font-size:1.4rem;">
            "O extraordinário é o nosso padrão."
          </div>
        </div>
      </div>

      <div style="display:flex;gap:18px;margin-top:30px;flex-wrap:wrap">
  ...
  <script>
    ...
    // PRODUTOS ATUALIZADOS (Com imagens REAIS que faltavam)
    const products = [
      {id:1,title:"Esmalte Aurora D'Or - Rosa Champagne",price:39.90,cat:"Esmalte",img:"https://images.unsplash.com/photo-1503602642458-232111445657?q=80&w=1200&auto=format&fit=crop",desc:"Cobertura gel, brilho intenso e longa duração."},
      {id:2,title:"Shampoo Liso D'Or 300ml",price:79.90,cat:"Cabelo",img:"https://images.unsplash.com/photo-1580910051071-9de39a4df6c0?q=80&w=1200&auto=format&fit=crop",desc:"Controle de frizz e brilho luxo para cabelos lisos."},
      {id:3,title:"Creme Definição Cacheada D'Or 250g",price:99.90,cat:"Cabelo",img:"https://images.unsplash.com/photo-1588345921523-7c6b0b4b6f9f?q=80&w=1200&auto=format&fit=crop",desc:"Definição e hidratação sem pesar."},
      {id:4,title:"Loção Corporal Velvet D'Or 400ml",price:129.90,cat:"Corpo",img:"https://images.unsplash.com/photo-1542326237-f8fd74997d53?q=80&w=1200&auto=format&fit=crop",desc:"Toque aveludado e fragrância sofisticada."},
      {id:5,title:"Sabonete Líquido Facial Gentle D'Or",price:59.90,cat:"Rosto",img:"https://images.unsplash.com/photo-1544052629-2f0a1b1a6f6f?q=80&w=1200&auto=format&fit=crop",desc:"Limpeza delicada e ação equilibrante."},
      {id:6,title:"Kit Mini Esmaltes Aurora (6 cores)",price:119.90,cat:"Esmalte",img:"https://images.unsplash.com/photo-1504639725590-34d0984388bd?q=80&w=1200&auto=format&fit=crop",desc:"Seleção exclusiva com cores da estação."},
      
      // IMAGENS NOVAS REAIS ADICIONADAS AQUI (substituindo placeholders)
      {id:7,title:"Perfume Aurora Essence",price:289.90,cat:"Perfume",img:"https://images.unsplash.com/photo-1594035910387-fea477942698?q=80&w=800&auto=format&fit=crop",desc:"Fragrância marcante com jasmim, âmbar e baunilha."},
      {id:8,title:"Golden Velvet Perfume",price:349.90,cat:"Perfume",img:"https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?q=80&w=800&auto=format&fit=crop",desc:"Notas florais envolventes com final amadeirado."},
      {id:9,title:"D'Or Signature",price:399.90,cat:"Perfume",img:"https://images.unsplash.com/photo-1541643600914-78b084683601?q=80&w=800&auto=format&fit=crop",desc:"Essência de rosa negra e almíscar branco."},
      {id:10,title:"Aurora Glow – Hidratante",price:129.90,cat:"Corpo",img:"https://images.unsplash.com/photo-1608248597279-f99d160bfbc8?q=80&w=800&auto=format&fit=crop",desc:"Textura leve com partículas douradas que iluminam a pele."},
      {id:11,title:"Royal Touch – Nutrição",price:159.90,cat:"Corpo",img:"https://images.unsplash.com/photo-1616683693504-3ea7e9ad6fec?q=80&w=800&auto=format&fit=crop",desc:"Hidratação intensa com manteiga de karité."},
      {id:12,title:"Serum Corporal Lux",price:199.90,cat:"Corpo",img:"https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=800&auto=format&fit=crop",desc:"Fórmula premium para restaurar brilho e maciez."},
      {id:13,title:"Batom Aurora Luxe",price:89.90,cat:"Maquiagem",img:"https://images.unsplash.com/photo-1586495777744-4413f21062fa?q=80&w=800&auto=format&fit=crop",desc:"Acabamento matte aveludado com alta durabilidade."},
      {id:14,title:"Golden Dreams Palette",price:199.90,cat:"Maquiagem",img:"https://images.unsplash.com/photo-1512496015851-a90fb38ba796?q=80&w=800&auto=format&fit=crop",desc:"12 tons luxuosos com pigmentação extrema."},
      {id:15,title:"Divine Light",price:119.90,cat:"Maquiagem",img:"https://images.unsplash.com/photo-1596462502278-27bfdd403348?q=80&w=800&auto=format&fit=crop",desc:"Glow dourado intenso com micropartículas."},
      {id:16,title:"Aurora Silk Soap",price:59.90,cat:"Banho",img:"https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?q=80&w=800&auto=format&fit=crop",desc:"Limpeza suave com fragrância floral sofisticada."},
      {id:17,title:"Golden Foam",price:74.90,cat:"Banho",img:"https://images.unsplash.com/photo-1556228720-192752988899?q=80&w=800&auto=format&fit=crop",desc:"Sabonete nutritivo com extratos naturais."},
      {id:18,title:"Velvet Bath",price:69.90,cat:"Banho",img:"https://images.unsplash.com/photo-1556228720-192752988899?q=80&w=800&auto=format&fit=crop",desc:"Espuma cremosa enriquecida com vitamina E."}
    ];

    // state
    let cart = [];
    // Carregar carrinho do localStorage se existir (persistência simples)
    if(localStorage.getItem('aurora_cart')){
    ...
    function checkout(){ 
      ...
      // OPCÃO 1: Redirecionar para o arquivo de checkout (checkout.html)
      // window.location.href = 'checkout.html';
      
      // OPÇÃO 2: Redirecionar para o Mercado Pago (Coloque seu link abaixo)
      // window.location.href = 'SEU_LINK_MERCADO_PAGO';
      
      alert('Redirecionando para pagamento seguro...');
      // Exemplo simulado de redirecionamento:
      window.location.href = 'checkout.html'; 
    }
